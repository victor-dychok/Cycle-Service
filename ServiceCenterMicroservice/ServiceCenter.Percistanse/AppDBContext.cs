...
namespace ServiceCenter.Percistance
{
    public class AppDBContext : DbContext
    {
        ...
        public DbSet<ServiceCenterUser> ServiceCenterUser { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RepairRequestEntity>().HasMany(e => e.Components);
            modelBuilder.Entity<RepairRequestEntity>().HasMany(e => e.Services);
